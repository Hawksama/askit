...
if ( !class_exists( 'BP_Better_Messages_Hooks' ) ):
    ...
    class BP_Better_Messages_Hooks
    {
        ...
        {
            if( BP_Better_Messages()->settings['fastStart'] == '1' ){
                return BP_Better_Messages()->functions->get_link() . '?new-message&fast=1&to=' . bp_core_get_username( BP_Better_Messages()->functions->get_member_id() );
            } else {
                return BP_Better_Messages()->functions->get_link() . '?new-message&to=' . bp_core_get_username( BP_Better_Messages()->functions->get_member_id() );
            }
        }
