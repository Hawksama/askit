        ...
        public function upload_form( $thread_id )
        {
            ...
            <script type="text/javascript">
                ...
                function insertButton() {
                    ...
                    var initiated = $('.bp-messages-wrap.bp-messages-wrap-main .reply form .message, .bp-messages-wrap.bp-better-messages-mini .chat[data-thread="<?php echo $thread_id; ?>"] .reply form .message').prepend('<span id="bpbm-upload-btn-<?php echo $thread_id; ?>" class="upload-btn"><i class="fas fa-paperclip" aria-hidden="true"></i><span class="count count-' + count + '">' + count + '</span></span>');
