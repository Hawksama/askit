...
class Grimlock_Login {
	...
	public function __construct() {
		...
		add_action( 'wp_footer',                          array( $this, 'add_login_form_modal' ), 100, 1 );
	}
	...
	public function enqueue_styles() {
		wp_enqueue_style( 'grimlock-login', GRIMLOCK_LOGIN_PLUGIN_DIR_URL . 'assets/css/login.css', array( 'login' ), GRIMLOCK_LOGIN_VERSION );
		wp_enqueue_style( 'grimlock-login-google-fonts', $this->get_google_fonts_url() );

		$custom_logo_url = apply_filters( 'grimlock_login_custom_logo_url', '' );
