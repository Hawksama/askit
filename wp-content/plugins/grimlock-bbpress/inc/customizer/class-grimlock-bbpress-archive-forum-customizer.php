<?php
/**
 * Grimlock_bbPress_Archive_Forum_Customizer Class
 *
 * @author  Themosaurus
 * @since   1.0.0
 * @package grimlock
...
/**
 * The Grimlock Customizer class for the forum archive pages.
 */
class Grimlock_bbPress_Archive_Forum_Customizer extends Grimlock_Template_Customizer {
	/**
	 * Setup class.
	 *
	 * @since 1.0.0
	...
	public function __construct() {
		...
		$this->section = 'grimlock_bbpress_archive_forum_customizer_section';
	...
	protected function is_template() {
		...
		return apply_filters( 'grimlock_bbpress_archive_forum_customizer_is_template', $is_template );
	}
	...
	public function add_customizer_fields() {
		...
		$this->defaults = apply_filters( 'grimlock_bbpress_archive_forum_customizer_defaults', array(
	...
	protected function add_title_field( $args = array() ) {
		if ( class_exists( 'Kirki' ) ) {
			...
			Kirki::add_field( 'grimlock', apply_filters( 'grimlock_bbpress_archive_forum_customizer_title_field_args', $args ) );
		}
	}
	...
	protected function add_description_field( $args = array() ) {
		if ( class_exists( 'Kirki' ) ) {
			...
			Kirki::add_field( 'grimlock', apply_filters( 'grimlock_bbpress_archive_forum_customizer_description_field_args', $args ) );
		}
	}
	...
	protected function add_custom_header_background_image_field( $args = array() ) {
		if ( class_exists( 'Kirki' ) ) {
			...
			Kirki::add_field( 'grimlock', $args );
		}
	}
}

return new Grimlock_bbPress_Archive_Forum_Customizer();
