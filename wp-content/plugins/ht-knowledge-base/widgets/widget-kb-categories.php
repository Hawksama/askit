	                ...
	                <?php
						...
						echo '<ul>';
						 foreach($categories as $category) { 
						    echo '<li><span>'. $category->count . '</span><a href="' . get_term_link( $category ) . '" title="' . sprintf( __( 'View all posts in %s', 'ht-knowledge-base' ), $category->name ) . '" ' . '>' . $category->name.'</a></li> ';
						 } 
						echo '</ul>';
						?>
