	...
	protected function add_text_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$outputs  = apply_filters( 'grimlock_typography_customizer_text_font_outputs', array(
				array(
					'element'  => ':root',
					'property' => '--grimlock-text-font-family',
					'choice'   => 'font-family',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-text-font-weight',
					'choice'   => 'font-weight',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-text-font-size',
					'choice'   => 'font-size',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-text-line-height',
					'choice'   => 'line-height',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-text-letter-spacing',
					'choice'   => 'letter-spacing',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-text-text-transform',
	...
	protected function add_heading_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$outputs = apply_filters( 'grimlock_typography_customizer_heading_font_outputs', array(
				array(
					'element'  => ':root',
					'property' => '--grimlock-heading-font-family',
					'choice'   => 'font-family',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-heading-letter-spacing',
					'choice'   => 'letter-spacing',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-heading-text-transform',
					'choice'   => 'text-transform',
				),
				array(
	...
	protected function add_heading1_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$outputs = apply_filters( 'grimlock_typography_customizer_heading1_font_outputs', array(
				array(
					'element'  => ':root',
					'property' => '--grimlock-heading1-font-size',
					'choice'   => 'font-size',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-heading1-line-height',
					'choice'   => 'line-height',
				),
				array(
					'element' => implode( ',', $elements )
	...
	protected function add_heading2_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$outputs = apply_filters( 'grimlock_typography_customizer_heading2_font_outputs', array(
				array(
					'element'  => ':root',
					'property' => '--grimlock-heading2-font-size',
					'choice'   => 'font-size',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-heading2-line-height',
					'choice'   => 'line-height',
				),
				array(
					'element' => implode( ',', $elements )
	...
	protected function add_heading3_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$outputs = apply_filters( 'grimlock_typography_customizer_heading3_font_outputs', array(
				array(
					'element'  => ':root',
					'property' => '--grimlock-heading3-font-size',
					'choice'   => 'font-size',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-heading3-line-height',
					'choice'   => 'line-height',
				),
				array(
					'element' => implode( ',', $elements )
	...
	protected function add_heading4_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$outputs = apply_filters( 'grimlock_typography_customizer_heading4_font_outputs', array(
				array(
					'element'  => ':root',
					'property' => '--grimlock-heading4-font-size',
					'choice'   => 'font-size',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-heading4-line-height',
					'choice'   => 'line-height',
				),
				array(
					'element' => implode( ',', $elements )
	...
	protected function add_heading5_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$outputs = apply_filters( 'grimlock_typography_customizer_heading5_font_outputs', array(
				array(
					'element'  => ':root',
					'property' => '--grimlock-heading5-font-size',
					'choice'   => 'font-size',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-heading5-line-height',
					'choice'   => 'line-height',
				),
				array(
					'element' => implode( ',', $elements )
	...
	protected function add_heading6_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$outputs = apply_filters( 'grimlock_typography_customizer_heading6_font_outputs', array(
				array(
					'element'  => ':root',
					'property' => '--grimlock-heading6-font-size',
					'choice'   => 'font-size',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-heading6-line-height',
					'choice'   => 'line-height',
				),
				array(
					'element' => implode( ',', $elements )
	...
	protected function add_display_heading_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$outputs = apply_filters( 'grimlock_typography_customizer_display_heading_font_outputs', array(
				array(
					'element'  => ':root',
					'property' => '--grimlock-display-heading-font-family',
					'choice'   => 'font-family',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-display-heading-letter-spacing',
					'choice'   => 'letter-spacing',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-display-heading-text-transform',
					'choice'   => 'text-transform',
				),
				array(
					'element' => implode( ',', $elements )
	...
	protected function add_display_heading1_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$outputs = apply_filters( 'grimlock_typography_customizer_display_heading1_font_outputs', array(
				array(
					'element'  => ':root',
					'property' => '--grimlock-display-heading1-font-size',
					'choice'   => 'font-size',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-display-heading1-line-height',
					'choice'   => 'line-height',
				),
				array(
					'element' => implode( ',', $elements )
	...
	protected function add_display_heading2_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$outputs = apply_filters( 'grimlock_typography_customizer_display_heading2_font_outputs', array(
				array(
					'element'  => ':root',
					'property' => '--grimlock-display-heading2-font-size',
					'choice'   => 'font-size',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-display-heading2-line-height',
					'choice'   => 'line-height',
				),
				array(
					'element' => implode( ',', $elements )
	...
	protected function add_display_heading3_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$outputs = apply_filters( 'grimlock_typography_customizer_display_heading3_font_outputs', array(
				array(
					'element'  => ':root',
					'property' => '--grimlock-display-heading3-font-size',
					'choice'   => 'font-size',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-display-heading3-line-height',
					'choice'   => 'line-height',
				),
				array(
					'element' => implode( ',', $elements )
	...
	protected function add_display_heading4_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$outputs = apply_filters( 'grimlock_typography_customizer_display_heading4_font_outputs', array(
				array(
					'element'  => ':root',
					'property' => '--grimlock-display-heading4-font-size',
					'choice'   => 'font-size',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-display-heading4-line-height',
					'choice'   => 'line-height',
				),
				array(
					'element' => implode( ',', $elements )
	...
	protected function add_subheading_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$outputs = apply_filters( 'grimlock_typography_customizer_subheading_font_outputs', array(
				array(
					'element'  => ':root',
					'property' => '--grimlock-subheading-font-family',
					'choice'   => 'font-family',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-subheading-font-weight',
					'choice'   => 'font-weight',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-subheading-font-size',
					'choice'   => 'font-size',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-subheading-line-height',
					'choice'   => 'line-height',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-subheading-letter-spacing',
					'choice'   => 'letter-spacing',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-subheading-text-transform',
					'choice'   => 'text-transform',
				),
				array(
					'element' => implode( ',', $elements )
	...
	protected function add_blockquote_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$outputs  = apply_filters( 'grimlock_typography_customizer_blockquote_font_outputs', array(
				array(
					'element'  => ':root',
					'property' => '--grimlock-blockquote-font-family',
					'choice'   => 'font-family',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-blockquote-font-weight',
					'choice'   => 'font-weight',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-blockquote-font-size',
					'choice'   => 'font-size',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-blockquote-line-height',
					'choice'   => 'line-height',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-blockquote-letter-spacing',
					'choice'   => 'letter-spacing',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-blockquote-text-transform',
					'choice'   => 'text-transform',
				),
				array(
					'element' => implode( ',', $elements ),
