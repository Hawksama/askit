...
class Grimlock_Archive_Customizer extends Grimlock_Grid_Template_Customizer {
	...
	protected function get_title_default() {
		return $this->has_posts_page() ? get_the_title( $this->posts_page->ID ) : $this->get_default( 'archive_title' );
	}
	...
	protected function get_description_default() {
		return $this->has_posts_page() ? $this->posts_page->post_excerpt : $this->get_default( 'archive_description' );
	}
	...
	protected function is_template() {
		$is_template = is_category() || is_tag() || is_date() || is_author() || is_tax( 'post_format' );
		return apply_filters( 'grimlock_archive_customizer_is_template', $is_template );
	}
