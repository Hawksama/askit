	...
	protected function add_blogname_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$outputs = apply_filters( 'grimlock_site_identity_customizer_blogname_font_outputs', array(
				array(
					'element'  => ':root',
					'property' => '--grimlock-site-identity-blogname-font-family',
					'choice'   => 'font-family',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-site-identity-blogname-font-weight',
					'choice'   => 'font-weight',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-site-identity-blogname-font-size',
					'choice'   => 'font-size',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-site-identity-blogname-line-height',
					'choice'   => 'line-height',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-site-identity-blogname-letter-spacing',
					'choice'   => 'letter-spacing',
				),
				array(
					'element'  => ':root',
					'property' => '--grimlock-site-identity-blogname-text-transform',
	...
	protected function add_custom_logo_size_field( $args = array() ) {
		if ( class_exists( 'Kirki' ) ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'choices'   => array(
					'min'   => 0,
					'max'   => isset( $custom_logo_args[0]['width'] ) ? $custom_logo_args[0]['width']/2 : 125,
					'step'  => 5,
				),
				'priority'  => 10,
				'output'    => $outputs,
