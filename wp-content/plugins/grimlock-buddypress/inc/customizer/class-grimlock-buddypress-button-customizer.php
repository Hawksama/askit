...
class Grimlock_BuddyPress_Button_Customizer {
	...
	public function add_border_radius_elements( $elements ) {
		return array_merge( $elements, array(
			...
			'#buddypress:not(.youzer) .card-footer div.action .dropdown .generic-button a',
		) );
	}
	...
	public function add_primary_background_color_elements( $elements ) {
		return array_merge( $elements, array(
			...
			//'#buddypress:not(.youzer) div.item-list-tabs#subnav > ul > li.current',
			//'#buddypress:not(.youzer) div.item-list-tabs#subnav > ul > li.selected',
			...
			'#buddypress:not(.youzer) table#message-threads tbody tr.unread:hover td',
			'#buddypress .bppp-bar',
		...
		return array_merge( $outputs, array(
			...
			array(
				'element'  => implode( ',', array(
					'#members-list.bp-card-list li.is-current-user .card',
			...
			array(
				'element'  => implode( ',', array(
					...
					'#buddypress:not(.youzer) .profile-content__body#item-body .screen-profile #profile-edit-form ul.button-nav > li:hover',
					'#groups-list-options a:hover',
					'#members-list-options a:hover',
					'#friends-list-options a:hover',
