									...
									<div class="card-body-actions action">
										<?php if ( count( bp_group_admin_ids( false, 'array' ) ) > 1 ) : ?>
											<div class="generic-button">
												<a class="button confirm admin-demote-to-member text-danger" href="<?php bp_group_member_demote_link(); ?>" data-toggle="tooltip" data-placement="top" title="<?php esc_html_e( 'Demote to Member', 'buddypress' ); ?>"><?php esc_html_e( 'Demote to Member', 'buddypress' ); ?></a>
											</div>
										<?php endif; ?>
						...
						<div class="card">
							...
							<div class="ov-h">
								...
								<div class="card-body pt-1 pb-4 pl-2 pr-2">
									...
									<div class="card-body-actions action">
										<div class="generic-button">
											<a href="<?php bp_group_member_promote_admin_link(); ?>" class="button confirm mod-promote-to-admin text-info" data-toggle="tooltip" data-placement="top" title="<?php esc_html_e( 'Promote to Admin', 'buddypress' ); ?>"><?php esc_html_e( 'Promote to Admin', 'buddypress' ); ?></a>
										</div>
										<div class="generic-button">
											<a class="button confirm mod-demote-to-member text-danger" href="<?php bp_group_member_demote_link(); ?>" data-toggle="tooltip" data-placement="top" title="<?php esc_html_e( 'Demote to Member', 'buddypress' ); ?>"><?php esc_html_e( 'Demote to Member', 'buddypress' ); ?></a>
										</div>
								...
								<div class="card-body pt-1 pb-4 pl-2 pr-2">
									...
									<div class="card-body-actions action">
										<?php if ( bp_get_group_member_is_banned() ) : ?>
											<div class="generic-button">
												<a href="<?php bp_group_member_unban_link(); ?>" class="button confirm member-unban text-success" data-toggle="tooltip" data-placement="top" title="<?php esc_html_e( 'Remove Ban', 'buddypress' ); ?>"><?php esc_html_e( 'Remove Ban', 'buddypress' ); ?></a>
											</div>
										<?php else : ?>
											<div class="generic-button">
												<a href="<?php bp_group_member_ban_link(); ?>" class="button confirm member-ban text-dark" data-toggle="tooltip" data-placement="top" title="<?php esc_html_e( 'Kick &amp; Ban', 'buddypress' ); ?>"><?php esc_html_e( 'Kick &amp; Ban', 'buddypress' ); ?></a>
											</div>
											<div class="generic-button">
												<a href="<?php bp_group_member_promote_mod_link(); ?>" class="button confirm member-promote-to-mod text-info" data-toggle="tooltip" data-placement="top" title="<?php esc_html_e( 'Promote to Mod', 'buddypress' ); ?>"><?php esc_html_e( 'Promote to Mod', 'buddypress' ); ?></a>
											</div>
											<div class="generic-button">
												<a href="<?php bp_group_member_promote_admin_link(); ?>" class="button confirm member-promote-to-admin text-info" data-toggle="tooltip" data-placement="top" title="<?php esc_html_e( 'Promote to Admin', 'buddypress' ); ?>"><?php esc_html_e( 'Promote to Admin', 'buddypress' ); ?></a>
											</div>
										<?php endif; ?>
										<div class="generic-button">
											<a href="<?php bp_group_member_remove_link(); ?>" class="button confirm remove text-danger" data-toggle="tooltip" data-placement="top" title="<?php esc_html_e( 'Remove from group', 'buddypress' ); ?>"><?php esc_html_e( 'Remove from group', 'buddypress' ); ?></a>
										</div>
