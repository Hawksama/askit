...
<div id="profile-header" class="profile-header--group">
			...
			<div class="row align-items-start align-items-lg-end h-100 pos-r">
				...
				<?php if ( ! bp_disable_group_avatar_uploads() ) : ?>
					<div class="profile-header__avatar col-auto pb-md-0 pb-4">
						...
						<?php if ( bp_group_is_admin() || bp_group_is_mod() ) : ?>
							<a href="<?php echo esc_url( bp_get_group_permalink() . 'admin/group-avatar' ); ?>" class="avatar-overlay-edit">
						...
						<?php if ( ! apply_filters( 'grimlock_buddypress_groups_actions_text_displayed', true ) ) : ?>
							<?php if ( is_user_logged_in() ) : ?>
								<div id="item-buttons" class="action action--bubbles">
				...
				<div class="profile-header__body col-12 col-md">
					...
					<div class="item-sumary mb-3">
						...
						<div class="item-summary__meta">
							...
							<div class="clear mb-2 d-md-inline-block"></div>
							<span class="separator text-muted d-none d-sm-inline mr-1">•</span>
					...
					<div class="item-description small font-weight-normal mb-3">
						<div><?php bp_group_type_list(); ?></div>
						<?php bp_group_description_excerpt(false, 240); ?>
					</div> <!-- .item-description -->

					<?php do_action( 'bp_group_header_meta' ); ?>

					<?php if ( apply_filters( 'grimlock_buddypress_groups_actions_text_displayed', true ) ) : ?>
						<div id="item-buttons" class="action">
							<?php do_action( 'bp_group_header_actions' ); ?>
						</div> <!-- .action -->
					<?php endif; ?>
