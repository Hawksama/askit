				...
				<div class="card ov-h">
					...
					<div class="ov-h">
							...
							<div class="card-img card-img--cover" <?php if ( ! bp_disable_group_cover_image_uploads() ) : ?>style="<?php echo esc_attr( $group_cover_style ); ?>"<?php endif; ?>>
								...
								<?php if ( ! bp_disable_group_avatar_uploads() ) : ?>
									...
									<div class="card-img__avatar">
										<span class="avatar-round-ratio big"><?php bp_group_avatar_thumb( 'width=' . bp_core_avatar_thumb_width() . '&height=' . bp_core_avatar_thumb_height() ); ?></span>
						...
						<div class="card-body pt-1 pb-4 pl-2 pr-2">
							...
							<div class="card-body-actions action group-action pb-2">
						...
						<div class="card-footer">
							<div class="item-meta">
								<strong>
									<?php esc_html( 'Active', 'buddypress' ); ?> <span class="activity" data-livestamp="<?php bp_core_iso8601_date( bp_get_group_last_active( 0, array( 'relative' => false ) ) ); ?>"><?php
										/* translators: %s: Last group active */
										printf( esc_html__( 'active %s', 'buddypress' ), esc_html( bp_get_group_last_active() ) ); ?></span>
								</strong>
							</div>

							<div class="item-desc"><?php bp_group_description_excerpt( false, 125 ); ?></div>
						</div> <!-- .card-footer -->
