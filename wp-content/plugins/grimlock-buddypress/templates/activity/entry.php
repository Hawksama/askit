	...
	<div class="activity-content">
		...
		<?php if ( is_user_logged_in() ) : ?>
			...
			<div class="activity-options">
				...
				<div class="dropdown dropdown-activity dropdown--inverted">
				...
				<?php if ( is_user_logged_in() && bp_activity_can_comment() ) : ?>
					...
					<form action="<?php bp_activity_comment_form_action(); ?>" method="post" id="ac-form-<?php bp_activity_id(); ?>" class="ac-form element-animated fade-in short"<?php bp_activity_comment_form_nojs_display(); ?>>
						<div class="ac-form-content d-flex">
							<div class="ac-reply-avatar d-flex align-self-start mr-3"><?php bp_loggedin_user_avatar( 'width=' . bp_core_avatar_full_width() / 5 . '&height=' . bp_core_avatar_full_height() / 5 . '&type=full' ); ?></div> <!-- .ac-reply-avatar -->
							<div class="media-body">
								...
								<input type="submit" name="ac_form_submit" value="<?php esc_attr_e( 'Post comment', 'buddypress' ); ?>" /> <a href="#" class="ac-reply-cancel btn btn-secondary"><?php esc_html_e( 'Cancel', 'buddypress' ); ?></a>
