...
?>
<div id="buddypress" class="<?php if ( class_exists( 'Mp_BP_Match' ) && ! bp_is_my_profile() ) : ?>bp-match-displayed<?php endif; ?> <?php if ( function_exists( 'bp_follow_init' ) && ! bp_is_my_profile() ) : ?>bp-follow-displayed<?php endif; ?>">
<?php
