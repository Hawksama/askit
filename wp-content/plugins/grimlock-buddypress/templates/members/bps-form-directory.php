...
<span <?php if ( ! empty( $filters_escaped->title ) ): ?>data-toggle="tooltip" data-placement="left" title="<?php echo $filters_escaped->title; ?>"<?php endif; ?>>
	<span class="sr-only"><?php echo ! empty( $filters_escaped->toggle_text ) ? esc_html( $filters_escaped->toggle_text ) : ''; ?></span>
</span>
</a>

<div class="modal p-0 fade" id="bpsModal_<?php echo esc_attr( $id_rand ); ?>" tabindex="-1" role="dialog" aria-labelledby="bpsModalLabel" aria-hidden="true">
								...
								<?php
									...
									?>
										...
										<div class="row">
											...
											<div class="col-12 col-sm-8 col-md-12 col-xl-8 mb-2 mb-sm-0 mb-md-2 mb-xl-0">
												<div class="pos-r">
											...
											<div class="col-8 col-sm-2 col-md-8 col-xl-2 pl-xl-0 pr-0">
											...
											<div class="col-4 col-sm-2 col-md-4 col-xl-2">
										...
										<div class="radio">
											<?php foreach ($filter_escaped_item->options as $key => $label) { ?>
												<label class="custom-control custom-radio">
													<input type="radio" class="custom-control-input" name="<?php echo $name.'[]'; ?>" value="<?php echo $key; ?>" <?php if (in_array ($key, $value)) echo 'checked="checked"'; ?> />
