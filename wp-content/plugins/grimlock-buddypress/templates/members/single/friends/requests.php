					...
					<div class="ov-h">
						...
						<div class="card-body pt-1 pb-4 pl-2 pr-2">
							...
							<div class="card-body-actions action">
								<a class="button accept friendship-button" href="<?php bp_friend_accept_request_link(); ?>" data-toggle="tooltip" data-placement="top" title="<?php esc_html_e( 'Accept', 'buddypress' ); ?>"><?php esc_html_e( 'Accept', 'buddypress' ); ?></a>
								<a class="button reject" href="<?php bp_friend_reject_request_link(); ?>" data-toggle="tooltip" data-placement="top" title="<?php esc_html_e( 'Reject', 'buddypress' ); ?>"><?php esc_html_e( 'Reject', 'buddypress' ); ?></a>
