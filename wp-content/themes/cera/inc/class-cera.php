	...
	class Cera {
		...
		public function setup() {
			...
			add_theme_support( 'editor-color-palette', array(
				array(
					'name'  => esc_html__( 'Primary', 'cera' ),
					'slug'  => 'primary',
					'color' => CERA_BRAND_PRIMARY,
				),
				array(
					'name'  => esc_html__( 'Secondary', 'cera' ),
					'slug'  => 'secondary',
					'color' => CERA_BRAND_SECONDARY,
				),
				array(
					'name'  => esc_html__( 'Gray Dark', 'cera' ),
					'slug'  => 'gray-color',
					'color' => CERA_GRAY_DARK,
				),
				array(
					'name'  => esc_html__( 'Gray', 'cera' ),
					'slug'  => 'gray',
					'color' => CERA_GRAY,
				),
				array(
					'name'  => esc_html__( 'Gray Light', 'cera' ),
					'slug'  => 'gray-color',
					'color' => CERA_GRAY_LIGHT,
				),
				array(
					'name'  => esc_html__( 'Gray Lighter', 'cera' ),
					'slug'  => 'gray-color',
					'color' => CERA_GRAY_LIGHTER,
				),
				array(
					'name'  => esc_html__( 'Gray Lightest', 'cera' ),
					'slug'  => 'gray-color',
					'color' => CERA_GRAY_LIGHTEST,
				),
				array(
					'name'  => esc_html__( 'Info', 'cera' ),
					'slug'  => 'info',
					'color' => CERA_BRAND_INFO,
				),
				array(
					'name'  => esc_html__( 'Danger', 'cera' ),
					'slug'  => 'danger',
					'color' => CERA_BRAND_DANGER,
				),
				array(
					'name'  => esc_html__( 'Success', 'cera' ),
					'slug'  => 'success',
					'color' => CERA_BRAND_SUCCESS,
				),
				array(
					'name'  => esc_html__( 'Warning', 'cera' ),
					'slug'  => 'warning',
					'color' => CERA_BRAND_WARNING,
				),
		...
		public function wp_enqueue_scripts() {
			 ...
			 * Enqueue scripts.
			 */
			wp_enqueue_script( 'cera-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '20130115', true );
			...
			wp_enqueue_script( 'cera-vertical-navigation', get_template_directory_uri() . '/assets/js/vertical-navigation.js', array( 'jquery', 'slideout' ), CERA_VERSION, true );

			wp_enqueue_script( 'jquery-masonry' );
			wp_enqueue_script( 'cera-grid',              get_template_directory_uri() . '/assets/js/grid.js',                 array( 'jquery', 'jquery-masonry' ), CERA_VERSION, true );
