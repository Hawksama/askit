...
if ( ! defined( 'CERA_HERO_TEXT' ) ) {
	define( 'CERA_HERO_TEXT', wp_kses( __( "", 'cera' ), $allowed_html ) );
}
...
if ( ! defined( 'CERA_HERO_COLOR_SCHEME' ) ) {
	define( 'CERA_HERO_COLOR_SCHEME', 'dark' );
}
...
if ( ! defined( 'CERA_WRAPPER_LAYOUT' ) ) {
	define( 'CERA_WRAPPER_LAYOUT', 'fluid' );
}
...
if ( ! defined( 'CERA_CARD_BORDER_WIDTH' ) ) {
	define( 'CERA_CARD_BORDER_WIDTH', 1 );
}
...
if ( class_exists( 'Jetpack' ) ) {
	global $cera_jetpack;
	$cera_jetpack = require get_template_directory() . '/inc/jetpack/class-cera-jetpack.php';
}

if ( class_exists( 'Grimlock_Jetpack' ) ) {
	global $cera_grimlock_jetpack;
	$cera_grimlock_jetpack = require get_template_directory() . '/inc/grimlock-jetpack/class-cera-grimlock-jetpack.php';
}
...
if ( function_exists( 'bbpress' ) ) {
	global $cera_bbpress;
	$cera_bbpress = require get_template_directory() . '/inc/bbpress/class-cera-bbpress.php';
}
...
if ( class_exists( 'Tribe__Events__Main' ) ) {
	global $cera_the_events_calendar;
	$cera_the_events_calendar = require get_template_directory() . '/inc/the-events-calendar/class-cera-the-events-calendar.php';
}
...
if ( function_exists( 'pmpro_init' ) ) {
	global $cera_paid_memberships_pro;
	$cera_paid_memberships_pro = require get_template_directory() . '/inc/paid-memberships-pro/class-cera-paid-memberships-pro.php';
}
